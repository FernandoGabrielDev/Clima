document.querySelector('.busca').addEventListener('submit', async (event) => { //verifica se o formulário foi enviado (verifica se o botão foi pressionado...)
    ...
    if (input !== ""){ //verificando se o input está preenchido
        ...
        let url = `https://api.openweathermap.org/data/2.5/weather?q=${encodeURI(input)}&appid=d836fe42eb3d0914414ede8d9031a30d&units=metric&lang=pt_br`; //URL DA API: Lembrar de oclocar o "encodeURI" para eliminar os espaços.
        //console.log(url);
